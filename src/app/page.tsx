...
const t = {
  en: {
    ...
    // Hero cards
    noCommLabel: "You get 100% of the money",
    ...
    // Costs section
    costsTitle: "An empty villa makes you lose money",
    costsOut: "COSTS OUT",
    costItems: ["Staff", "Pool", "Garden", "Electricity", "Water", "Repairs"],
    standbyIn: "STANDBY IN",
    standbyDesc: "Bumpr guests stop you from losing money",
    costsDesc: "Bumpr guests pay nightly. Makes you earn, instead of losing \u2014 you choose your rate.",
    costs18h: "And when a full-price booking comes \u2014 18 hours, your villa is yours again.",
    // How you take villa back
    howTitle: "How To Get Your Villa Back",
    ...
    howEarned: "You earned, you didn\u2019t lose money.",
    // Calendar
  ...
  id: {
    ...
    howEarned: "Anda untung, Anda tidak rugi.",
